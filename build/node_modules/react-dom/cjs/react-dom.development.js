...
// 生成新的子Fiber节点并赋值给workInProgress.child，作为本次beginWork返回值 (opens new window)，
...
// “递”阶段，首先从rootFiber开始向下深度优先遍历。为遍历到的每个Fiber节点调用beginWork方法 
...
function beginWork(current, workInProgress, renderLanes) {
  ...
  // 通过current === null ?来区分组件是处于mount还是update，首次渲染，current是null
  ...
  if (current !== null) {
    ...
    // didReceiveUpdate === false时，可复用fiber
...
function commitRootImpl(root, renderPriorityLevel) {
  ...
  if (firstEffect !== null) {
    ...
    do {
      {
        // commitBeforeMutationEffects：beforeMutation阶段的主函数
